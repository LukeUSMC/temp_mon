...
bool DS18B20::dsreset(){
  bool isAsserted = ds->reset();
  return isAsserted;
}

bool DS18B20::search(){
    bool isSuccess =  ds->search(addr);
...
float DS18B20::getTemperature(){
    ...
    HAL_Delay_Milliseconds(750);     // maybe 750ms is enough, maybe not
